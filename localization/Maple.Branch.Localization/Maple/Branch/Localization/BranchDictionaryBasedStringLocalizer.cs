...
using MapleClub.Utility.Globalization;
using Microsoft.Extensions.Localization;

namespace Maple.Branch.Localization
{
    public class BranchDictionaryBasedStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
    {
        ...
        public BranchDictionaryBasedStringLocalizer(LocalizationResource resource, List<IStringLocalizer> baseLocalizers)
        {
            Resource = resource;
        ...
        protected virtual LocalizedString? GetLocalizedStringOrNull(string name, string cultureName, bool tryDefaults = true)
        {
            ...
            if (Resource.DefaultCultureName.NotNullOrEmpty())
            {
        ...
        public class CultureWrapperStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
        {
            ...
            private readonly BranchDictionaryBasedStringLocalizer _innerLocalizer;
            ...
            public CultureWrapperStringLocalizer(string cultureName, BranchDictionaryBasedStringLocalizer innerLocalizer)
            {
